...
f.execs(
	"rsync " + exclusions + " -r --whole-file --exclude=.electron --exclude=node_modules --exclude=scripts --exclude=lib --exclude=python3 --exclude=stack --exclude=electron --exclude=tauri ~/adventureland/* ~/deploy/" + folder + "",
);
