...
var npcs={
	...
	"citizen17":{
		...
		"role":"citizen",
		"skin":"mbody4b",
		"cx":{"head":"mmakeup02","hair":"hairdo219","hat":"hat202","back":"backpacks00"},
		"type":"fullstatic",
		...
		"delay":6000,
		"level":40,
		"says":["Need a bearing?","Dunes shift. Landmarks help.","I know three useful stops."],
		"interaction":["Lost in the sand? Pick a name, and I'll show the first steps."],
	},
	"citizen18":{
		"name":"Patch",
		"role":"citizen",
		"skin":"mbody2d",
		"cx":{"head":"makeup119","hair":"hairdo309","face":"face102","back":"backpacks03"},
		"type":"fullstatic",
		"citizen_behavior":"repairer",
		"speed":24,
		"hp":4200,
		"delay":5000,
		"level":52,
		"says":["Easy, little worker.","Loose bolt, bright spark.","Fighting? I'll wait."],
		"interaction":["If a mechagnome idles, I patch it up. If it starts swinging, I keep my fingers clear."],
	},
	"citizen19":{
		"name":"Moss",
		"role":"citizen",
		"skin":"mbody3f",
		"cx":{"head":"mmakeup04","hair":"hairdo424","hat":"hat323","back":"backpacks00"},
		"type":"fullstatic",
		"citizen_behavior":"fairy_echo",
		"speed":20,
		"hp":3600,
		"delay":7000,
		"level":48,
		"says":["A fairy passed this way.","Red, green, blue... hush.","Light remembers wings."],
		"interaction":["Stand near a fairy and watch my motes. They borrow its color for a little while."],
	},
	"citizen20":{
		"name":"Wick",
		"role":"citizen",
		"skin":"marmor8a",
		"cx":{"head":"mmakeup02","hair":"hairdo406","hat":"gcandle","back":"backpacks200"},
		"type":"fullstatic",
		"citizen_behavior":"lamplighter",
		"citizen_lamp_stops":[[0,8],[384,-40],[688,-104],[880,40],[1168,-48]],
		"speed":22,
		"hp":4800,
		"delay":1200,
		"level":54,
		"says":["One stop, one flame.","Warm light holds here.","Mind the unlit turns."],
		"interaction":["I walk the tunnel and leave warm pools of light. The dark keeps moving, so I do too."],
	},
	"citizen22":{
		"name":"Merrit",
		"role":"citizen",
		"skin":"mbody4b",
		"cx":{"head":"mmakeup05","hair":"hairdo406","hat":"hat213","back":"backpacks03"},
		"type":"fullstatic",
		...
		"market":{
			"radius":600,
			"exchange":[[2697000,"scroll0",5],[1977800,"cscroll0",2],[1618200,"seashell",5],[1258600,"leather",2],[899000,"scroll1",1],[359600,"gem1",1],[134850,"cscroll1",1],[35960,"offeringp",1],[8990,"gem0",1],[2000,"duskweavehood",1],[2000,"caravanbrigandine",1],[2000,"mirrorsteelgauntlet",1],[2000,"ironheelboots",1],[2000,"tollkeeperspike",1]],
			"chase":["duskweavehood","caravanbrigandine","mirrorsteelgauntlet","ironheelboots","tollkeeperspike"],
			"npc_clearance":40,
			"stand_clearance":10,
			"front_clearance":15,
			"front_width":10,
	...
	"citizen21":{
		...
		"role":"citizen",
		"skin":"mbody1e",
		"cx":{"head":"fmakeup04","hair":"hairdo510","hat":"hat103","back":"backpacks02"},
		"type":"fullstatic",
		"citizen_behavior":"tavern_echo",
		"speed":18,
		"hp":3000,
		"delay":8000,
		"level":36,
		"says":["Show me a flourish.","I can follow that.","A bow finishes it."],
		"interaction":["Try Wiggle, Head Wiggle, Joy, or Jump nearby. Give me a beat, and I'll copy it."],
	},
	"holo0":{
		"name":"Green",
		"role":"citizen",
...
npcs.dreamkeeper={name:"Dorr",role:"dreamkeeper",skin:"oldcitizen",type:"fullstatic",says:["Going inside? Bring your party close."],interaction:["You have 24 minutes inside. Stay together."]};
