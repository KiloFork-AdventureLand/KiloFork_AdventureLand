...
if(typeof projectiles==="undefined"){ try{ projectiles=require("./projectiles").projectiles; }catch(e){ try{ projectiles=require("./design/projectiles").projectiles; }catch(e2){ var projectiles={}; } } }
for(var id in projectiles){
	if(projectiles[id]["animation"] && animations[projectiles[id]["animation"]] && animations[projectiles[id]["animation"]]["speed"]){
