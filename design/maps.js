...
var maps = {
	...
	original_main: {
		...
		npcs: [
			...
			}, //currently the direction is hard-coded at update_sprite [30/08/16]
		...
		quirks: [[664, -55, 20, 16, "sign", "An Offshore Bank"]],
		pvp: false,
		drop_norm: 700,
		instance: true,
	},
	test: {
		...
		key: "test",
		name: "Test",
		npcs: [{ name: "Transporter", id: "transporter", position: [-50, -50] }],
		monsters: [],
		spawns: [[0, 0]],
		no_bounds: true,
		irregular: true,
	...
	dungeon0: {
		...
		name: "Dungeon",
		npcs: [],
		monsters: [{ type: "goo", boundary: [-50, -50, 50, 50], count: 5 }],
		spawns: [[0, 0]],
		on_death: ["dungeon0", 0],
		doors: [],
		pvp: true,
	...
	old_bank: {
		...
		monsters: [],
		spawns: [[56, 129, 3]],
		doors: [[56, 187, 64, 40, "main", 5, 0]],
		quirks: [[56, -52, 16, 34, "log", "It's time."]],
		mount: true,
		ignore: true,
	},
	bank: {
		...
		quirks: [[-40.34, -448.85, 26.77, 42.69, "log", "It's time."]],
		on_exit: ["main", 3],
		mount: true,
		safe: true,
		lux: 0.8,
	...
	d2: {
		...
		name: "Dark World",
		npcs: [],
		monsters: [{ type: "d_wiz", boundary: [-49, -679, 51, -640], count: 1, gatekeeper: true, rage: [-172, -685, 219, -437] }],
		spawns: [
			[0, -15],
			[0, -671],
		],
	...
	d_e: {
		...
		npcs: [{ id: "transporter", position: [-9, 0] }],
		monsters: [],
		spawns: [
			[-9.2, -0.91],
			[0.08, -291.85],
	...
	cave: {
		...
		monsters: [
			...
			{ type: "bat", boundary: [964, 11, 1252, 107], count: 2, grow: true }, //added grow 31/1/2024
			{
				type: "mvampire",
				boundaries: [
					["cave", -367, -1296, -14, -1057],
					["cave", 1068, -123, 1420, 78],
				],
				count: 1,
				stype: "randomrespawn",
			},
	...
	main: {
		...
		name: "Mainland",
		seasonal_npcs: [{ id: "anniversary_baker", position: [64, -88], event: "anniversary" }],
		npcs: [
			...
			{ id: "funtokens", position: [303, -87] || [105, -34] || [220, -151] },
			...
			{ id: "secondhands", position: [106, -47] || [74, -34] },
	...
	jail: {
		key: "jayson_al_jail",
		name: "Jail",
		npcs: [{ id: "jailer", position: [191, -156] }],
		monsters: [{ type: "jrat", boundary: [-223, -140, 225, 156], count: 3 }],
		doors: [],
		quirks: [[-81, -165, 30, 40, "log", "Locked"]],
		spawns: [[-79, -153]],
		drop_norm: 1000,
		irregular: true,
		lux: 0.5,
	...
	woffice: {
		...
		monsters: [{ type: "grinch", boundary: [-112, -142, 60, -16], count: 1, special: true }],
		doors: [[-29, 112, 48, 40, "main", 1, 0]],
		spawns: [[-24, 83, 3]],
		zones: [
			{
				type: "mining",
	...
	resort_e: {
		...
		monsters: [],
		doors: [[-8, 120, 40, 24, "tavern", 1, 0]],
		spawns: [[-8, 91, 3]],
		quirks: [[-8, -92, 20, 24, "the_lever"]],
		drop_norm: 1000,
		lux: 1,
	},
	resort: {
	...
	winter_inn_rooms: {
		...
		npcs: [],
		monsters: [],
		doors: [[0, 25, 24, 20, "winter_inn", 1, 0]],
		spawns: [[-0, -8, 3]],
		quirks: [],
		drop_norm: 1000,
		unlist: true,
	...
	winter_cove: {
		...
		doors: [[-9, 64, 51, 37.5, "winter_cave", 1, 0]],
		spawns: [
			[-7.5, 9.5, 3],
			[509.71, -228.7],
			[253.08, -1849],
	...
	winter_instance: {
		...
		doors: [[-7.23, 250.26, 38.15, 28.55, "winterland", 5, 0]],
		spawns: [[-8, 216, 3]],
		quirks: [],
		drop_norm: 4000,
		instance: true,
	...
	shellsisland: {
		...
		name: "New Town!",
		npcs: [{ id: "wizardrepeater", position: [-190, 26] }],
		monsters: [
	...
	spookytown: {
		...
		quirks: [[-63, -44, 30, 24, "invisible_statue"]],
		ref: {
	...
	tunnel: {
		...
		name: "Mining Tunnel",
		npcs: [{ id: "gemmerchant", position: [-264, -96, 2] }],
		monsters: [
	...
	arena: {
		...
		spawns: [[151.6, 40.82]],
		doors: [[152.99, 85.42, 60.9, 40.55, "main", 6, 0]],
	...
	mforest: {
		...
		npcs: [{ id: "citizen19", position: [0, 48], boundary: [-120, -80, 120, 160] }],
		monsters: [
