docs = {
	...
	interactions: {
		...
		tavern: {
			...
			icon: "xshot",
			summary: "Read the house rules before placing a dice, slots or wheel wager.",
			functions: ["get_tavern_info", "bet_dice", "play_slots", "bet_wheel"],
			proximity: true,
		},
		gathering: {
	...
	interaction_map: {
		...
		machines: { dice: "tavern", slots: "tavern", wheel: "tavern" },
	...
	guide: [
		...
		[
			...
			[
				...
				["tavern-games", "Tavern Games", "tavern,dice,slots,wheel,fortune,wager,house edge", "#C78A6B"],
